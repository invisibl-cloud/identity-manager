...
# identity-manager.io/identity-manager-bundle:$VERSION and identity-manager.io/identity-manager-catalog:$VERSION.
IMAGE_TAG_BASE ?= identity-manager.io/identity-manager
